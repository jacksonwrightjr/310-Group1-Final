<html>
    ...
    <a href = "#googleMapsElement" style="font-family: Arial, Helvetica, sans-serif; font-weight:bold">Need Directions?</a>
        ...
        <div class = "imgcontainer" style = "margin-left:auto;margin-right:auto;">
          <img src="img/tooth.png" alt="Cabo logo" style="height:30%;width: 20%; text-align: center;" alt="Avatar" class="avatar">
          <p>Welcome to the Aggieland Dentistry Portal! Sign in or <a href="register.php">create an account</a>.</p>
        </div>
